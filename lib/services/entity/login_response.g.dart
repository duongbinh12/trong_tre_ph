...
LoginData _$LoginDataFromJson(Map<String, dynamic> json) => LoginData(
      ...
      json['chinh_sach_dieu_khoan'] as String?,
      json['chinh_sach_bao_mat'] as String?,
      json['quy_che_hoan_huy'] as String?,
...
Map<String, dynamic> _$LoginDataToJson(LoginData instance) => <String, dynamic>{
      ...
      'chinh_sach_dieu_khoan': instance.chinh_sach_dieu_khoan,
      'chinh_sach_bao_mat': instance.chinh_sach_bao_mat,
      'quy_che_hoan_huy':instance.quy_che_hoan_huy,
