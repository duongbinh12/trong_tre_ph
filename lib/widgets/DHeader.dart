...
class DHeader extends StatelessWidget {
  const DHeader({super.key,required this.title,this.colorTitle,this.showMenu,this.noBack=false,this.keyMenu});
  final String title;
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        ):SizedBox(width: 48.sp,height: 40.sp,),
        Expanded(child: AppText(
          title,
          maxLines: 1,
          textAlign: TextAlign.center,
          style: AppStyle.DEFAULT_20_BOLD.copyWith(color: colorTitle??AppColors.black,height: 1.1),
        )),
        showMenu==true?InkWell(
          onTap: (){
            try{
